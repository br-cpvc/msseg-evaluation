...
$python3 concat_csv_files.py -i $dataverse_dir/test/*/*/wmh-sc_measurements.csv $dataverse_dir/test/*/*/*/wmh-sc_measurements.csv -o wmh-sc_measurements_all.csv

echo "STEP: generating: c3d_overlap1_all.csv"
$python3 concat_csv_files.py -i $dataverse_dir/test/*/*/c3d_overlap1.csv $dataverse_dir/test/*/*/*/c3d_overlap1.csv -o c3d_overlap1_all.csv

echo "STEP: generating: timing_in_seconds_all.csv"
$python3 concat_csv_files.py -i $dataverse_dir/test/*/*/*/timing_record_in_seconds.csv $dataverse_dir/test/*/*/timing_record_in_seconds.csv  -o timing_record_in_seconds_all.csv

echo "STEP: generating: measurements.csv"
$python3 merge_csv_files.py -m image_id -i c3d_overlap1_all.csv wmh-sc_measurements_all.csv -o measurements.csv

echo "STEP: generating: measurements_summery.csv"
$python3 describe_data.py -i measurements.csv -t -o measurements_summery.csv

echo "STEP: generating: timing_record_in_seconds_summery.csv"
$python3 describe_data.py -i timing_record_in_seconds_all.csv -t -o timing_record_in_seconds_summery.csv
